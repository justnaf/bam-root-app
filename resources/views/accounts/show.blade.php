<x-app-layout>
    <x-slot name="header">
        <h2 class="font-semibold text-xl text-gray-800 leading-tight">
            <a href="{{route('user.index')}}">User Management</a> > <span>Show</span>
        </h2>
    </x-slot>
                    ...
                    <div class="relative overflow-x-auto">
                        ...
                        <div class="flex space-x-7 justify-center items-center w-full mb-3">
                            <div class="bg-gray-300 shadow-lg p-4 w-64 h-80 flex items-center justify-center">
                                ...
                                <p>No Picture</p>
                                @else
                                <img src="{{asset($user->dataDiri->profile_picture)}}" alt="{{$user->dataDiri->name}}" class="w-full h-full object-cover">
                                @endif
                                @endif
                            </div>
                            <div class=" p-4">
